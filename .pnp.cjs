...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "packageRegistryData": [
      ...
      ["typescript", [
        ["patch:typescript@npm%3A4.8.3#~builtin<compat/typescript>::version=4.8.3&hash=32657b", {
          "packageLocation": "./.yarn/cache/typescript-patch-0ded4165cc-57acee3231.zip/node_modules/typescript/",
          "packageDependencies": [
            ["typescript", "patch:typescript@npm%3A4.8.3#~builtin<compat/typescript>::version=4.8.3&hash=32657b"]
          ],
          "linkType": "HARD",
